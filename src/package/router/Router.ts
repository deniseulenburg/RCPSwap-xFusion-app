...
import { findMultiRouteExactIn, getBigNumber, MultiRoute, NetworkInfo, RouteStatus, RPool, RToken } from '../tines'
...
export class Router {
  ...
  static routeProcessor2Params(
    ...
    return {
      ...
      amountOutMin,
      to,
      routeCode: getRouteProcessor2Code(route, RPAddr, RPAddr, poolCodesMap, permits),
      value: fromToken instanceof Token ? undefined : route.amountInBN
    }
  }
