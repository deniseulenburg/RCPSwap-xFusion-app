...
import { ARB, BRICK, DAI, MOON, SUSHI, Token, USDC, USDT, WBTC, WETH9, WNATIVE } from '../../currency'
...
export const BASES_TO_CHECK_TRADES_AGAINST: {
  ...
  [ChainId.HARMONY]: [WNATIVE[ChainId.HARMONY], USDC[ChainId.HARMONY], USDT[ChainId.HARMONY], DAI[ChainId.HARMONY]],
