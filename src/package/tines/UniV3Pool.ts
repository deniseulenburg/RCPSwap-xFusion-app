...
function getSqrtRatioAtTick(tick: number): BigNumber {
  ...
  if ((absTick & 0x2) != 0) ratio = ratio.mul(c03).shr(128)
  if ((absTick & 0x4) != 0) ratio = ratio.mul(c04).shr(128)
  if ((absTick & 0x8) != 0) ratio = ratio.mul(c05).shr(128)
  if ((absTick & 0x10) != 0) ratio = ratio.mul(c06).shr(128)
  if ((absTick & 0x20) != 0) ratio = ratio.mul(c07).shr(128)
  if ((absTick & 0x40) != 0) ratio = ratio.mul(c08).shr(128)
  if ((absTick & 0x80) != 0) ratio = ratio.mul(c09).shr(128)
  if ((absTick & 0x100) != 0) ratio = ratio.mul(c10).shr(128)
  if ((absTick & 0x200) != 0) ratio = ratio.mul(c11).shr(128)
  if ((absTick & 0x400) != 0) ratio = ratio.mul(c12).shr(128)
  if ((absTick & 0x800) != 0) ratio = ratio.mul(c13).shr(128)
  if ((absTick & 0x1000) != 0) ratio = ratio.mul(c14).shr(128)
  if ((absTick & 0x2000) != 0) ratio = ratio.mul(c15).shr(128)
  if ((absTick & 0x4000) != 0) ratio = ratio.mul(c16).shr(128)
  if ((absTick & 0x8000) != 0) ratio = ratio.mul(c17).shr(128)
  if ((absTick & 0x10000) != 0) ratio = ratio.mul(c18).shr(128)
  if ((absTick & 0x20000) != 0) ratio = ratio.mul(c19).shr(128)
  if ((absTick & 0x40000) != 0) ratio = ratio.mul(c20).shr(128)
  if ((absTick & 0x80000) != 0) ratio = ratio.mul(c21).shr(128)

  if (tick > 0) ratio = max256.div(ratio)
