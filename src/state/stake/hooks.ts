import { CurrencyAmount, JSBI, Token, TokenAmount, Pair, Fraction } from '@rcpswap/sdk'
...
export function useStakingInfo(active: boolean | undefined = undefined, pairToFilterBy?: Pair | null): StakingInfo[] {
  ...
  const lpTokenBalances = useMultipleContractSingleData(lpTokenAddresses, PAIR_INTERFACE, 'balanceOf', undefined, [
